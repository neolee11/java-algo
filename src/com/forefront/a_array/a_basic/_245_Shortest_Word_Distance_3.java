 ...
 */
public class _245_Shortest_Word_Distance_3 {

    public static void solve() {

        _245_Shortest_Word_Distance_3 solver = new _245_Shortest_Word_Distance_3();

        String[] words = new String[]{"practice", "makes", "perfect", "coding", "makes"};
        String word1 = "coding";
        String word2 = "practice";
//        int result= solver.shortestWordDistance(words, word1, word2);
