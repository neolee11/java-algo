...
public class _134_Gas_Station {
    ...
    public static void solve() {
        ...
        _134_Gas_Station solver = new _134_Gas_Station();
...
//        int[] cost = new int[]{3,4,3};
        ...
        int result = solver.canCompleteCircuit_lc(gas, cost);

        System.out.println("Gas");
        util.printIntArray(gas);

        System.out.println("Cost");
        util.printIntArray(cost);
...
//    }
    ...
    public int canCompleteCircuit_lc(int[] gas, int[] cost) {
